...
import Test.Hspec
import Lib (listLength, reverseList, toDigitsRev, toDigits, doubleEveryOther, sumDigits, validate, test, mergeDigits)
...
--      (test [1, 3, 8, 6]) `shouldBe` (18 :: Integer)
--      (mergeDigits [1, 3, 16, 6]) `shouldBe` ([1, 3, 1, 6, 6] :: [Integer])
